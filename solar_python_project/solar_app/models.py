...
class Register(models.Model):
    ...
    Workcode = models.ForeignKey('Dividend', on_delete=models.CASCADE, db_column='Workcode', blank=True, null=True)
...
class Dividend(models.Model):
    ...
    Adate = models.CharField(max_length=10, blank=True, null=True)
    ...
    Bunho = models.ForeignKey('Register', on_delete=models.CASCADE, db_column='Bunho')
    Saveurl = models.CharField(max_length=50, blank=True, null=True)
    Worker = models.CharField(max_length=20, blank=True, null=True)
